...
$('document').ready(function(){
		...
		$(window).resize(function(){
			 vw = $(window).width()/2;
			$('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9, #b10, #b00').stop();
			...
			$('#b00').animate({top:240, left: vw+250},500);
		});
	...
	$('#wish_message').click(function(){
		...
		$('#b10').attr('id','b100')
		$('#b0').attr('id','b00')
		$('#b11').animate({top:200, left: vw-100},500);
		$('#b22').animate({top:200, left: vw-0},500);
		$('#b33').animate({top:200, left: vw+100},500);

		$('#b44').animate({top:300, left: vw-230},500);
		$('#b55').animate({top:300, left: vw-170},500);
		$('#b66').animate({top:300, left: vw-120},500);
		$('#b77').animate({top:300, left: vw-60},500);
		$('#b88').animate({top:300, left: vw+0},500);
		$('#b99').animate({top:300, left: vw+50},500);
		$('#b100').animate({top:300, left: vw+100},500);
		$('#b00').animate({top:300, left: vw+130},500);
